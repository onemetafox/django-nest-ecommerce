...
class ProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ("id", "slug", "get_auth_user_email", "get_auth_user_first_name",
                    "get_auth_user_last_name",  "accept_offers_and_newsletters", "created_at")
...
class BillingAddressAdmin(admin.ModelAdmin):
    ...
    list_display = ("id", "slug", "get_auth_user_email", "phone_number", "company_name",
                    "address", "city", "province", "postal_code", "created_at", "country", "cif")
...
class ShippingAddressAdmin(admin.ModelAdmin):
    ...
    list_display = ("id", "slug", "get_auth_user_email", "phone_number", "name",
                    "address", "city", "province", "postal_code", "created_at", "country")
    search_fields = ("id", "slug", )
    readonly_fields = ("id", "slug",)
    list_display_links = ("id", "slug")
